...
class InvoiceLines {
    @Resource("{id}")
    class Id(
        @Suppress("unused") val parent: InvoiceLines = InvoiceLines(),
 ...
 */
fun Application.configureInvoiceLineRouting(repository: InvoiceLineRepository = getK<InvoiceLineRepository>()) {
    routing {
